...
public class EslintBridgeServerImpl implements EslintBridgeServer {
  ...
  void startServer(SensorContext context, List<Path> deployedBundles) throws IOException {
    ...
    initNodeCommand(context, scriptFile, bundles, context.fileSystem().workDir());
  ...
  private void initNodeCommand(SensorContext context, File scriptFile, String bundles, File workDir) throws IOException {
    nodeCommandBuilder
